...
constructor(){
  this.services=[
{bgi:"assets/images/playlist1.jpg",para:"tSwitch between themes with just a click.Modify the built-in themes or create your own using Sleeve’s extensive preferences.",img:"assets/images/Artwork1.jpg",head:"Change it up"},
